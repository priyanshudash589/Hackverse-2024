    ...
    <>
      <div id="about" className="h-full ">
        <div className="container-fix">
          <div className="border-[#00968F] flex flex-col gap-8 border bg-transparent container-fix rounded-xl shadow-upperShadow shadow-[#00968F]/70">
            ...
            <p className="text-justify text-xs md:text-sm tracking-widest">
              HackVerse isn't just a hackathon, it's a community catalyst. We
              empower tech-savvy youth in India to develop broader
              problem-solving skills and foster meaningful connections. In a
              nation brimming with tech potential, HackVerse bridges the gap by
              cultivating an inclusive community with a global perspective. Join
              our Hybrid Event: Take Part in person as a part of our 24-hour
              in-person hackathon. Over 150 attendees,will collaborate and
              compete for exciting prizes. Embrace the Future of Web3:
              HackVerse, Chennai's biggest Web3 event, brings together over 700
              enthusiasts and leading tech companies. We're excited to showcase
              the power of Web3 and its potential to shape the future. More Than
              Just Coding: HackVerse goes beyond coding challenges. We
              prioritize productivity and security, fostering effective teamwork
              and protecting intellectual property. Be a Part of the Movement:
              Over 2,000 individuals have already registered for HackVerse. Join
              us for 36 hours of non-stop innovation alongside 500 passionate
              Web3 developers. Join a Respectful Community: HackVerse fosters a
              respectful and inclusive environment. Participants retain
              ownership of their projects while granting HackVerse the right to
              showcase their work for non-commercial purposes. Make Your Mark:
              Be a part of the Web3 revolution at HackVerse! Sign up now to work
              with us to create a more promising future.
            </p>
          </div>
